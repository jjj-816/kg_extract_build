...
AUDIT_TASK_LIBRARY_PATH = audit_env_path(
    ...
    PROJECT_ROOT / "docs" / "audit-task-library" / "v1" / "audit-task-library.v1.1.1.json",
)
AUDIT_DETERMINISTIC_RULE_SET_PATH = audit_env_path(
    "KG_AUDIT_DETERMINISTIC_RULE_SET_PATH",
    PROJECT_ROOT / "docs" / "audit-task-library" / "v1" / "audit-deterministic-rules.v1.0.2.json",
)
