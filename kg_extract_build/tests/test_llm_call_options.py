...
class LLMCallOptionsTests(unittest.TestCase):
    def test_extractor_includes_thinking_options(self):
        ...
        with patch("kg_extract_build.extractor.OpenAI"):
        ...
        extractor.client = _fake_client(completions)
    ...
    def test_aligner_includes_thinking_options(self):
        ...
        with patch("kg_extract_build.entity_aligner.OpenAI"):
        ...
        aligner.client = _fake_client(completions)
    ...
    def test_single_entity_triplet_includes_thinking_options(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            with patch("kg_extract_build.triplets.OpenAI"):
